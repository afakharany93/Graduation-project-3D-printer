...
class Thermistor_3d
{
	public:
		...
		float series_resistor = 98100;		//used to hold the value of the series resistor in ohms
		unsigned char average_samples = 10;		//variable used to hold the number of samples taken to calculate the average
		float res_debug_val;
